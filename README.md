...
library(ggplot2)
 ...
 trust |> 
  ...
  autoplot()
```
![](https://github.com/user-attachments/assets/e9cc00ec-2790-42d3-8809-bb38bf15c5da | width = 70)

```r
autoplot(amce_res)
```
![](https://github.com/user-attachments/assets/e3bd2861-97ba-42b6-a3da-0dc28b389108 | width = 70)
